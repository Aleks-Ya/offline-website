...
public class PackageTaskTest {
    ...
    public void call() throws Exception {
        RootLink rootLink = new LinkImpl("http://google.com");
        TestFactory factory = new TestFactory(rootLink);
        String pageUrlStr = "http://google.com/data.html";
        Link link = new LinkImpl(pageUrlStr);
        String html = "<html></html>";
        ResourceId<PackagingRes> packagingResId = factory.createPackagingRes(link, html, TestFactory.httpInfoDefault);
        ...
        assertThat(packagedRes.getUrl().getOrigin(), equalTo(pageUrlStr));
