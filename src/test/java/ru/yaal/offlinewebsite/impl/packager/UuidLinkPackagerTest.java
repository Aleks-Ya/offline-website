...
public class UuidLinkPackagerTest {
    ...
    public void pack() throws IOException {
        ...
        RootLink rootLink = new LinkImpl(rootUrlStr);

        TestFactory factory = new TestFactory(rootLink);
        String rootHtml = "<html><body><a href='nested_page.html'>Janino</a></body></html>";
        ResourceId<PackagingRes> rootPackagingResId = factory.createPackagingRes(rootLink, rootHtml, TestFactory.httpInfoDefault);
    ...
    public void urlsDifferOnlyFragments() throws Exception {
        ...
        Link link1 = new LinkImpl("http://ya.ru/contacts.html#phone");
        Link link2 = new LinkImpl("http://ya.ru/contacts.html#address");

        String html = "<html><body>345-45-67</body></html>";

        ResourceId<PackagingRes> packagingResId1 = factory.createPackagingRes(link1, html, TestFactory.httpInfoDefault);
        ResourceId<PackagingRes> packagingResId2 = factory.createPackagingRes(link2, html, TestFactory.httpInfoDefault);
