...
public class SyncInMemoryStorageImplTest {
    ...
    private final RootResUrl rootResUrl = new ResUrlImpl(urlStr);
    ...
    public void createNewResource() {
        ResourceId<NewRes> newResId = storage.createNewResource(rootResUrl);
    ...
    public void alreadyExistsNew() {
        storage.createNewResource(rootResUrl);
    ...
    public void getPackagingResourceIds() {
        ...
        ResourceId<PackagingRes> packagingResId =
                factory.createPackagingRes(rootResUrl, "<html></html>", TestFactory.httpInfoDefault);
