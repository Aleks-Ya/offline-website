...
public class OfflinePathResolverImplTest {
    ...
    public void internetUrlToOfflinePath() {
        ...
        PageUrl pageUrl = new PageUrlImpl("http://ya.ru:80/russia/spb.html?query=abc");
        Path path = resolver.internetUrlToOfflinePath(outletDir, pageUrl);
    ...
    public void noQuery() {
        Path outletDir = Paths.get("c:/tmp/outlet");
        PageUrl pageUrl = new PageUrlImpl("http://ya.ru:80/russia/spb.html");
        Path path = resolver.internetUrlToOfflinePath(outletDir, pageUrl);
    ...
    public void noPath() {
        Path outletDir = Paths.get("c:/tmp/outlet");
        PageUrl pageUrl = new PageUrlImpl("http://ya.ru:80");
        Path path = resolver.internetUrlToOfflinePath(outletDir, pageUrl);
    ...
    public void noPort() {
        Path outletDir = Paths.get("c:/tmp/outlet");
        PageUrl pageUrl = new PageUrlImpl("http://ya.ru/russia");
        Path path = resolver.internetUrlToOfflinePath(outletDir, pageUrl);
    ...
    public void fileProtocol() {
        Path outletDir = Paths.get("c:/tmp/outlet");
        PageUrl pageUrl = new PageUrlImpl("file:/C:/yaal/nested_page.html");
        Path path = resolver.internetUrlToOfflinePath(outletDir, pageUrl);
